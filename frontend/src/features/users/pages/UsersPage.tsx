      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm flex flex-col justify-between overflow-hidden">
        ...
        <div className="p-4 border-b border-slate-150 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50/50 dark:bg-slate-905/30">
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 text-xs border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-hidden bg-white dark:bg-slate-800 dark:text-white"
            />
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-850 border-b border-slate-100 dark:border-slate-800 text-[9.5px] uppercase font-bold text-slate-400 tracking-wider">
        ...
        {isAddOpen && (
          <div className="fixed inset-0 z-55 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl max-w-md w-full p-6 space-y-4 shadow-2xl relative z-10 text-left animate-in fade-in zoom-in-95 duration-150"
            >
              ...
              <form onSubmit={handleCreateSubmit} className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full text-xs p-2.5 border border-slate-205 dark:border-slate-700 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-indigo-500 bg-transparent dark:text-white"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full text-xs p-2.5 border border-slate-205 dark:border-slate-700 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-indigo-505 bg-transparent dark:text-white font-mono"
                  />
                </div>
