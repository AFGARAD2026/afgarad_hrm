      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 space-y-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm space-y-3">
            <h3 className="text-xs font-bold text-slate-800 dark:text-white uppercase tracking-wider">Settings Hub</h3>
            <p className="text-[10px] text-slate-400">Configure administrative rules, aesthetic design sheets, and database controllers.</p>
            
            <div className="pt-2 border-t border-slate-50 dark:border-slate-800 space-y-1">
              <span className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-semibold text-indigo-600 bg-indigo-50/50 dark:text-indigo-400 dark:bg-indigo-950/20 rounded-xl leading-none">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                <h4 className="text-xs font-bold text-slate-900 dark:text-white">Workspace Aesthetic Design</h4>
                ...
                <button
                  ...
                  className={`flex items-center justify-between p-3 border rounded-xl text-left cursor-pointer transition-all ${
                    accentColor === acc.value 
                      ? 'border-indigo-600 bg-indigo-50/30 dark:bg-indigo-950/25' 
                      : 'border-slate-100 dark:border-slate-800 bg-slate-50/20 dark:bg-slate-805/30 hover:bg-slate-5 hover:dark:bg-slate-800'
                  }`}
                >
                  <div className="flex items-center gap-2">
                    <span className={`w-3.5 h-3.5 rounded-full ${acc.bg} shrink-0`}></span>
                    <span className="text-xs font-semibold text-slate-705 dark:text-slate-300">{acc.name}</span>
                  </div>
                  {accentColor === acc.value && (
                    <span className="text-[10px] text-indigo-650 dark:text-indigo-405 font-bold">Active</span>
                  )}
                </button>
              ))}
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm space-y-4">
            <div className="flex items-center gap-2">
              <div className="p-2 bg-emerald-50 dark:bg-emerald-955/20 text-emerald-600 dark:text-emerald-400 rounded-lg">
                <Building2 size={16} />
              </div>
              <div className="text-left">
                <h4 className="text-xs font-bold text-slate-900 dark:text-white">Corporate System Parameters</h4>
            ...
            <form onSubmit={handleSaveWorkspaceSettings} className="space-y-4 pt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <select 
                    ...
                    className="w-full text-xs font-bold px-3 py-2.5 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-850 dark:text-white rounded-xl focus:border-indigo-500 focus:outline-hidden cursor-pointer"
                  >
              ...
              <div className="pt-2 flex justify-end">
                <button 
                  type="submit"
                  className="inline-flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-505 text-white font-bold text-xs rounded-xl px-4 py-2.5 cursor-pointer shadow-sm transition-all text-center"
                >
                  Apply Parameters
                </button>
              </div>
          ...
          {/* Sandbox Controls */}
          <div className="bg-white dark:bg-slate-900 border-2 border-dashed border-rose-200 dark:border-rose-900/40 rounded-xl p-5 shadow-sm space-y-4">
            <div className="text-left font-sans">
              <h4 className="text-xs font-bold text-rose-800 dark:text-rose-450">Sandbox Developer Panel</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 pt-2">
              <button
                type="button"
                onClick={clearLogs}
                className="inline-flex items-center justify-center gap-1.5 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-705 text-slate-700 dark:text-slate-250 font-bold text-xs border border-slate-200 dark:border-slate-700 rounded-xl py-2.5 px-4 cursor-pointer transition-all"
              >
                <Trash2 size={13} />
                Flush Audit Logs
              </button>
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 bg-rose-50 dark:bg-rose-955/20 hover:bg-rose-100 dark:hover:bg-rose-900 text-rose-700 dark:text-rose-400 font-bold text-xs border border-rose-100 dark:border-rose-900/40 rounded-xl py-2.5 px-4 cursor-pointer transition-all"
              >
                <RotateCcw size={13} />
                Reset Sandbox DB
              </button>
