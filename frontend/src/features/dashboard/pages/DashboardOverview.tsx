  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{totalEmployees}</p>
            <p className="text-[10px] text-slate-500 font-medium">Registered profiles</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0 border border-indigo-100/30">
            <Users size={16} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-emerald-600 dark:text-emerald-405 tracking-tight">{activeEmployees}</p>
            <p className="text-[10px] text-slate-500 font-medium">Duty status active</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0 border border-emerald-100/30">
            <UserCheck size={16} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{totalDepartmentsCount}</p>
            <p className="text-[10px] text-slate-500 font-medium">Business units</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0 border border-blue-100/30">
            <Building2 size={16} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-indigo-600 dark:text-indigo-400 tracking-tight">{attendancePercentage}%</p>
            <p className="text-[10px] text-slate-500 font-medium">{presentToday} present today</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-violet-50 dark:bg-violet-950/30 text-violet-600 dark:text-violet-400 flex items-center justify-center shrink-0 border border-violet-100/30">
            <Clock size={16} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className={`text-2xl font-black tracking-tight ${pendingLeaves > 0 ? 'text-amber-600 animate-pulse' : 'text-slate-900 dark:text-white'}`}>{pendingLeaves}</p>
            <p className="text-[10px] text-slate-500 font-medium">Requires assessment</p>
          </div>
          <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 border ${pendingLeaves > 0 ? 'bg-amber-50 text-amber-600 dark:bg-amber-950/30 dark:text-amber-400 border-amber-100/30' : 'bg-slate-50 dark:bg-slate-800 text-slate-500 border-slate-100'}`}>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-rose-600 dark:text-rose-450 tracking-tight">${currentMonthPayroll.toLocaleString()}</p>
            <p className="text-[10px] text-slate-500 font-medium">This month payments</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-rose-50 dark:bg-rose-950/30 text-rose-600 dark:text-rose-450 flex items-center justify-center shrink-0 border border-rose-100/30">
            <DollarSign size={16} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{totalOvertimeHours} Hrs</p>
            <p className="text-[10px] text-slate-500 font-medium">Aggregated excess</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 border border-amber-100/30">
            <Plus size={16} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{completedReviewsCount}</p>
            <p className="text-[10px] text-slate-500 font-medium">Satisfied KPI goals</p>
          </div>
          <div className="w-9 h-9 rounded-lg bg-pink-50 dark:bg-pink-950/30 text-pink-600 dark:text-pink-450 flex items-center justify-center shrink-0 border border-pink-100/30">
            <ShieldCheck size={16} />
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Employee Growth</h3>
            ...
            <div className="flex items-center gap-1 bg-slate-50 dark:bg-slate-800 rounded-lg p-1">
              <span className="px-2 py-0.5 text-[9px] bg-white dark:bg-slate-900 rounded shadow-2xs font-extrabold text-slate-700 dark:text-slate-300 font-mono">2026</span>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm flex flex-col justify-between">
          <div className="space-y-1">
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Department Distribution</h3>
          ...
          <div className="h-44 relative flex items-center justify-center my-2">
            ...
            <div className="absolute text-center">
              <p className="text-xl font-extrabold text-slate-800 dark:text-slate-100">{totalEmployees}</p>
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            {departmentData.map((d) => (
              <div key={d.name} className="flex items-center gap-1.5 min-w-0">
                ...
                <span className="text-[10px] text-slate-600 dark:text-slate-400 truncate font-semibold">{d.name} ({d.value})</span>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm space-y-4">
          <div>
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Payroll Summary</h3>
      ...
      >
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm md:col-span-1 flex flex-col justify-between">
          <div className="space-y-1">
            <h3 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Recent Employees</h3>
            ...
            {employees.slice(0, 3).map((emp) => (
              <div key={emp.id} className="flex items-center gap-2.5">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs font-bold text-slate-800 dark:text-slate-200 truncate leading-none mb-1 text-left">{emp.name}</p>
                  <p className="text-[9.5px] text-slate-500 truncate text-left">{emp.role} • {emp.department}</p>
                </div>
              </div>
            ))}
          </div>
          <button 
            ...
            className="w-full text-center mt-4 text-[10.5px] text-slate-500 hover:text-indigo-600 font-bold py-1.5 border-t border-slate-100 dark:border-slate-850 transition-all cursor-pointer"
          >
            Review Directory →
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm md:col-span-1 flex flex-col justify-between">
          <div className="space-y-1">
            <h3 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Recent Leave Requests</h3>
          ...
          <div className="space-y-3 mt-4 flex-1">
            {leaveRequests.filter(l => l.status === 'Pending').length === 0 ? (
              <div className="h-full py-8 flex flex-col items-center justify-center text-center text-slate-400">
                ...
                <p className="text-[10px] font-bold text-slate-700 dark:text-slate-300">All Sorted Out</p>
                <p className="text-[9px] mt-0.5">No pending leaves.</p>
              </div>
            ) : (
              leaveRequests.filter(l => l.status === 'Pending').slice(0, 2).map((l) => (
                <div key={l.id} className="p-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-800 rounded-lg space-y-1.5">
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className="text-[10.5px] font-bold text-slate-800 dark:text-slate-200 truncate">{l.employeeName}</p>
                  </div>
                  <p className="text-[9.5px] text-slate-500 text-left">{l.type} • {l.days} days</p>
                </div>
              ))
            )}
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm md:col-span-1 flex flex-col justify-between">
          <div className="space-y-1">
            <h3 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider">Upcoming Reviews</h3>
            <p className="text-[10px] text-slate-400">Assigned KPI benchmarks trackers</p>
          </div>
          <div className="space-y-3.5 mt-4 flex-1">
            {goals.slice(0, 3).map((goal) => (
              <div key={goal.id} className="space-y-1 leading-none text-left">
                <div className="flex justify-between items-center">
                  <p className="text-xs font-bold text-slate-800 dark:text-slate-200 truncate max-w-[130px]">{goal.employeeName}</p>
                  <span className="text-[9px] font-mono bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-400 px-1 py-0.5 rounded font-extrabold">{goal.progress}%</span>
                </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm md:col-span-1 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-1 gap-2 mt-4 flex-1 justify-center">
            <button 
              ...
              className="flex items-center justify-between p-2.5 bg-indigo-50/50 hover:bg-indigo-50 dark:bg-indigo-950/20 dark:hover:bg-indigo-950/30 border border-indigo-100/40 dark:border-indigo-900/30 text-indigo-700 dark:text-indigo-400 rounded-lg text-left text-2xs font-extrabold transition-all duration-150 cursor-pointer"
            >
            ...
            <button 
              ...
              className="flex items-center justify-between p-2.5 bg-emerald-50/50 hover:bg-emerald-50 dark:bg-emerald-950/20 dark:hover:bg-emerald-950/30 border border-emerald-100/40 dark:border-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-lg text-left text-2xs font-extrabold transition-all duration-150 cursor-pointer"
            >
            ...
            <button 
              ...
              className="flex items-center justify-between p-2.5 bg-amber-50/50 hover:bg-amber-50 dark:bg-amber-950/20 dark:hover:bg-amber-950/30 border border-amber-100/40 dark:border-amber-900/30 text-amber-700 dark:text-amber-400 rounded-lg text-left text-2xs font-extrabold transition-all duration-150 cursor-pointer"
            >
              <span>Configure Corporate Units</span>
              <ArrowRight size={12} />
            </button>
          </div>
          <div className="pt-2 text-[9px] text-slate-400 font-medium text-center italic border-t border-slate-100 dark:border-slate-850 mt-2">
